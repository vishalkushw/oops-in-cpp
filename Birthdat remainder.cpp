...
public:
  set_today_date()
  display_date()
  Birth_day_reminder()--> user enter a DOB, function calculate after how
   many days yours birthday will come,if user give false input
   (eg: past birthdate) error message will occur.
*/
